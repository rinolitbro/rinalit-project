...
public class SweepScript : MonoBehaviour
{
	...
	private void Wander()
	{
		...
		this.coolDown = 1f;
		this.wanders++;
		Laybary.sprite = LaybarySweep;
		Invoke("WaterDrop", 5.0f);
	}
	...
	public SpriteRenderer Laybary;
	public Sprite LaybaryDefault;
	public Sprite LaybarySweep;

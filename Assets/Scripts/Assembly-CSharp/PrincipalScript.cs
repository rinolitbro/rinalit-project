...
public class PrincipalScript : MonoBehaviour
{
	...
	private void CorrectPlayer()
	{
		...
		else if (this.playerScript.guiltType == "bomb")
		{
			this.audioQueue.QueueAudio(audNoBomb);
		}
	}
	...
	private void OnTriggerStay(Collider other)
	{
		...
		{
			MistyTWN.sprite = MistyDissapointed;
			this.inOffice = true;
	...
	public SpriteRenderer MistyTWN;

	public Sprite MistyAngry;
	public Sprite MistyDissapointed;
	public Sprite MistyDefault;

	public AudioClip audNoBomb;
}
